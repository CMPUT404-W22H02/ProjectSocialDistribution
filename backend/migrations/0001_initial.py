    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.DateTimeField(default='2022-03-31T14:10:17+00:00', editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ManyToManyField(to='backend.Comment')),
                ('follows', models.ManyToManyField(to='backend.Follow')),
                ('likes', models.ManyToManyField(to='backend.Like')),
